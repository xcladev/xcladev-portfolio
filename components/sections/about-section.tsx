          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <p className="text-lg text-muted-foreground leading-relaxed">
                Mi trayectoria se ha centrado principalmente en el ecosistema{" "}
                <span className="font-semibold">PHP/Laravel</span>,
                desarrollando plataformas a medida e integrando{" "}
                <span className="font-semibold">APIs internacionales</span> para
                mejorar procesos y la experiencia de usuario en el sector
                turístico.
                <br /> Además, he trabajado con{" "}
                <span className="font-semibold">Python</span> para la creación
                de APIs REST, proyectos de análisis de datos, soluciones IA, y
                actualmente amplío mi perfil hacia el{" "}
                <span className="font-semibold">desarrollo full stack</span> con{" "}
              ...
              <Card className={hoverEffects.cardHover}>
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    ...
                    empresas y startups, con enfoque en backend, integraciones y
              ...
              <Card className={hoverEffects.cardHover}>
                ...
                <CardContent>
                  <ul className="space-y-2 list-disc pl-5 text-muted-foreground">
                    <li>CFGS en Desarrollo de Aplicaciones Web (en curso)</li>
                    <li>Curso de Especialización en IA y Big Data</li>
                    <li>CFGS en Desarrollo de Aplicaciones Multiplataforma</li>
                  </ul>
                </CardContent>
              </Card>
            </div>
